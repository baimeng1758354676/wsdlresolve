 ...
 * @description: soap相关常量
 * @Author: baimeng
 * @Date: 2020/6/3 10:46
 */
public class SoapConstant {

    public final static QName ENVELOPE_QNAME = new QName(SoapConstant.SOAP11, "Envelope","soapenv");
    public final static QName BODY_QNAME = new QName(SoapConstant.SOAP11, "Body","soapenv");
    public final static QName FAULT_QNAME = new QName(SoapConstant.SOAP11, "Fault","soapenv");
    public final static QName HEADER_QNAME = new QName(SoapConstant.SOAP11, "Header","soapenv");
     ...
     * 默认的soap1.1命名空间
     */
    public final static String SOAP11 = "http://schemas.xmlsoap.org/soap/envelope/";
